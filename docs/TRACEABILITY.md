...
| P6-whatsapp | §8.3 (WhatsApp), §9 (ingestion_sources) | Phase 6 | WhatsApp Cloud API webhook, same extraction pipeline, live inbound panel | ✅ Done |
| P7-multilingual | §6.1 (extraction), §5.7 (code-mixed) | Phase 7 | Hindi-English, Tamil-English, Telugu-English extraction, benchmark set | ✅ Done |
